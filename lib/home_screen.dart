import 'package:bmi_application/bmi_calculator.dart';
import 'package:bmi_application/result_screen.dart';
import'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:bmi_application/bmi_button.dart';
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        body: Padding(
          padding:
           EdgeInsets.symmetric(horizontal: 16.0.sp,vertical: 24.0.sp,
           ),
           child: Column(
                          ...
                          children: [
                            bmiCard(
                              ...
                              child: Row(
                                ...
                                children: [
                                  BmiButton(icon:Icons.remove,
                                    onPressed: (){
                                    setState(() {
                                       age--;
                                    });
                                  },),
                                  BmiButton(icon:Icons.add,
                                       onPressed: () {
                                         setState(() {
                                           age++;
                                         });
